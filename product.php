...
<body class="animsition">
		...
		<div class="container-menu-header">
			<div class="wrap_header">
				...
				<div class="header-icons">
					<!-- The user clicks on this icon to create an account -->
		...
		<div class="wrap-side-menu" >
			<nav class="side-menu">
				<ul class="main-menu">
					...
					<li class="item-menu-mobile">
						<a href="cart.php">Post Product</a>
					</li>
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/prodbanner.jpg);">
		<h2 class="l-text2 t-center">
			NetBuy
		</h2>
		<p class="m-text13 t-center">
			We provide you with wider variety and coverage to buy and sell
		</p>
	</section>
